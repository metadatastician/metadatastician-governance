...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/metadatastician-governance/security/advisories/new)
...
- This repository (`metadatastician/metadatastician-governance`) and all its code
...
When using Metadatastician Governance, we recommend:
...
*Thank you for helping keep Metadatastician Governance and its users safe.* 🛡️
